...
chatFrameScanner:SetScript("OnEvent", function(self,event,message,sender,chanString,chanNumber,chanName,_,_,_,_,_,_,guid)
	...
	message =  message:gsub("{square}", "")--remove marks
	message =  message:gsub("{skull}", "")--remove marks
	message =  message:gsub("{moon}", "")--remove marks
	message =  message:gsub("{star}", "")--remove marks
	message =  message:gsub("{circle}", "")--remove marks
	message =  message:gsub("{skull}", "")--remove marks
	------------------CLASS COLORS
	local classColor
